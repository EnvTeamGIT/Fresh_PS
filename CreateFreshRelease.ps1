...
$deliveryteam = $ListBox.Text
$StartTimeTemp = $Textbox4.Text
$releasetype = $ListBox2.Text
$APIKeyAdmin = Get-Content  -Path "\\LDSFILEPROAPP01\Systems\Shared\Service Transition\Environment Management\Environment Team Docs\Usefully stuff\PowerShell\Fresh\Key.txt" | ConvertTo-SecureString
